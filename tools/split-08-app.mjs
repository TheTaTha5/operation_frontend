...
export const DOMAINS = {
  'booking.js':       { title: 'Booking v2 · by-trip · seat locks · reconfirm · boat capacity',
                            prefixes: ['bkV2', 'bk', 'bkx', 'ba', 'bcap', 'boat', 'ovn', 'rs', 'nat', 'rc', 'bt'] },
  'agents.js':        { title: 'Agents · sales team · add-on services · seed data',
                            prefixes: ['ag', 'agp', 'tm', 'aos', 'seed'] },
  'rates.js':         { title: 'Rate Types',
                            prefixes: ['rt', 'rtm', 'get'] },
  'contracts.js':     { title: 'Contracts · contract templates · costing & boat rent',
                            prefixes: ['ct', 'ctt'] },
  'checkin.js':       { title: 'Check-in (van + pier) · guide jobs · meals',
                            prefixes: ['ck', 'pck', 'vck', 'go', 'mv'] },
  'vans.js':          { title: 'Vans · van jobs · van bill · vehicles · pickup setup',
                            prefixes: ['van', 'vj', 'vjt', 'vb', 'veh', 'psu'] },
  'cash.js':          { title: 'Pier cash · petty cash',
                            prefixes: ['pc', 'po'] },
  'accounting.js':    { title: 'Accounting · daily PFM · travel summary',
                            prefixes: ['acct', 'pfm', 'ts'] },
  'reports.js':       { title: 'Reports · analysis · daily report · market data · pickup map · B2C dashboard',
                            prefixes: ['rep', 'px', 'dr', 'drm', 'md', 'pm', 'pmap', 'b'] },
  'boatjob.js':      { title: 'Boat job sheet (ใบงานเรือ)',
                            prefixes: ['pj'] },
};
